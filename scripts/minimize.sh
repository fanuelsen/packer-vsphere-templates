...
apt-get -y purge accountsservice bind9-host busybox-static command-not-found dmidecode \
    ...
    ncurses-term publicsuffix python-apt-common shared-mime-info ssh-import-id \
    tasksel tcpdump ufw usb.ids usbutils uuid-runtime xdg-user-dirs #os-prober ntfs-3g parted pci.ids pciutils plymouth popularity-contest powermgmt-base 
